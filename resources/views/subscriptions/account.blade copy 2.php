    ...
    <table class="w-full text-sm border border-gray-200 rounded-lg">
      ...
      <tbody>
        ...
        <tr class="border-t">
          ...
          <td class="px-3 py-2"><span class="{{ $invoice->status_class }}">{{ $invoice->status_label }}</span></td>
          <td class="px-3 py-2 text-right">
            <a href="{{ route('subscriptions.invoice.download', $invoice->id) }}" class="link-default">Ver Fatura</a>
          </td>
        </tr>
        @endforeach
      </tbody>
